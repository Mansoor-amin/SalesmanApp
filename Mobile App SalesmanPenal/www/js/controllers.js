...
app.constant('herokuUrl',"https://mysalesmanapp.herokuapp.com");

app.controller('LoginCtrl', function($scope,$http, $state, herokuUrl) {
    $scope.user = {};
    $scope.LoginUser = function(){
        $http.post(herokuUrl + "/loginSalesman", {data : $scope.user})
...
app.controller('HomeCtrl', function($scope, $http, $state, herokuUrl) {

      $http.get(herokuUrl + "/get-company-salesman")
        .success(function(response){
...
app.controller('createOrderCtrl', function($scope, $http, $state, $cordovaGeolocation, herokuUrl) {
    $scope.order = {};
    ...
    $scope.createOrder = function(){
      ...
      $cordovaGeolocation
        ...
        .then(function (position) {
          ...
          $http.post(herokuUrl + "/createOrder", {data : $scope.order})
            .success(function(response){
              console.log(response);
              $state.go("home");
            })
